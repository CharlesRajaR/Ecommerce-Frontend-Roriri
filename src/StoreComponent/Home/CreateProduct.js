...
const CreateProduct = () => {
  ...
  const handleSubmit = (e) =>{
    ...
    dispatch(createProduct({jwt, productReq:{...formData, "images":formImage}}))
              ...
              <IconButton size='small' sx={{position:'absolute', top:0, right:0, outline:"none"}}
               onClick={() => handleRemoveImage(index)}>
                <Close sx={{fontSize:"1rem"}}/>
                 ...
                 <input class="mb-2 mt-2 shadow appearance-none border rounded w-full py-4 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
