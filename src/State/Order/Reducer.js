...
import { CREATE_CART_ORDER_FAILURE, CREATE_CART_ORDER_REQUEST, CREATE_CART_ORDER_SUCCESS, CREATE_SINGLE_ORDER_FAILURE, CREATE_SINGLE_ORDER_REQUEST, CREATE_SINGLE_ORDER_SUCCESS, DELETE_ORDER_FAILURE, DELETE_ORDER_SUCCESS, GET_ITEM_ORDER_FAILURE, GET_ITEM_ORDER_REQUEST, GET_ITEM_ORDER_SUCCESS, GET_USER_ORDER_FAILURE, GET_USER_ORDER_REQUEST, GET_USER_ORDER_SUCCESS } from "./ActionType"
...
export const userOrderReducer = (state=initialState, action) =>{
    switch(action.type){
        ...
        case GET_ITEM_ORDER_SUCCESS:
            return{
              ...state, isLoading:false, error:null, orderItem:action.payload
            }
